...
const AddContact = () => {
  ...
  useEffect(() => {
    const paragraph = new SplitType(paragraphRef.current);
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(
        "https://contact-management-navy.vercel.app/contact/postContact",
        data
      )
      .then((res) => {
        if (res.data.status) {
    ...
    <div className="max-w-screen-xl px-4 mx-auto">
      <div className="mb-4">
        ...
        <div ref={paragraphRef} className="">
          <p>
            You can add contacts. By clicking submit button you can add new
            contact.{" "}
          </p>
        </div>
      </div>
